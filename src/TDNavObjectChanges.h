...
#ifndef TDNAVOBJECTCHANGES_H
#define TDNAVOBJECTCHANGES_H
...
//class TDNavObjectChanges : public NavObjectChanges
class TDNavObjectChanges : public pugi::xml_document
{
    public:
        TDNavObjectChanges();
        TDNavObjectChanges( wxString file_name );
        virtual ~TDNavObjectChanges();
